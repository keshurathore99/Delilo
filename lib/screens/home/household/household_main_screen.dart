...
class HouseholdMainScreen extends StatefulWidget {
  @override
  _HouseholdMainScreenState createState() => _HouseholdMainScreenState();
}

class _HouseholdMainScreenState extends State<HouseholdMainScreen> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder<QuerySnapshot>(
            future: Firestore.instance.collection('household').getDocuments(),
