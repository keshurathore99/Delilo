        ...
        body: FutureBuilder<DocumentSnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              if (sellerProducts == null) {
                return Center(
                  child: Text('No Product Till Now'),
                );
              }
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      mobileList.length == 0
                          ? Container()
                          : SellerHomeScreenCard('Mobile', mobileList.length,
                              mobileList, 'mobile'),
                      dairyList.length == 0
                          ? Container()
                      ...
                      beautyList.length == 0
                          ? Container()
                          : SellerHomeScreenCard('Beauty', beautyList.length,
                              beautyList, 'beauty'),
                      ...
                      sportsList.length == 0
                          ? Container()
                          : SellerHomeScreenCard('Sports', sportsList.length,
                              sportsList, 'sports'),
                      toysList.length == 0
                          ? Container()
                          : SellerHomeScreenCard(
                      ...
                      travelList.length == 0
                          ? Container()
                          : SellerHomeScreenCard('Travel', travelList.length,
                              travelList, 'travel'),
                    ],
                  ),
                ),
